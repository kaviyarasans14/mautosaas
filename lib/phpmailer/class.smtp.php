 ...
 * @version $Id: class.smtp.php,v 1.1.1.2 2015/11/18 11:02:41 prabhu Exp $
 */
...
class SMTP {
	...
	/**
	 * Sets the SMTP PHPMailer response data
	 *
	 * @var string
	 */
	
	public $success_response= ''; //the reponse of success mail send
...
$tval ); // give up after ? secs
	...
	public function Data($msg_data) {
		...
		if ($code != 250) {
			...
			$this->success_response= $rply;
			//echo "Success Reponse: " . $rply . '><><' . $this->CRLF . '<br />';
		}
		return true;
	}
